...
public class JWTFilter extends OncePerRequestFilter {
    ...
    public JWTFilter(JWTUtil jwtUtil, CrutUserDetailsService personDetailsService) {
        this.jwtUtil = jwtUtil;
        this.crutUserDetailsService = personDetailsService;
    }
        ...
        if (authHeader != null && !authHeader.isBlank() && authHeader.startsWith("Bearer ")) {
            ...
            if (jwt.isBlank()) {
                ...
                try {
                    ...
                    UserDetails userDetails = crutUserDetailsService.loadUserByUsername(username);
