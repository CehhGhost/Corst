  ...
  <div class="q-pa-md">
    ...
    >
      ...
      <template v-slot:body-cell-id="props">
        <q-td
          :props="props"
          @click="goToDomainPage(props.row.id)"
...
export default {
  ...
  methods: {
    ...
    deleteDomains() {
      const confirmation =
        this.$i18n.locale === "ru"
          ? confirm("Вы уверены, что хотите удалить выбранные домены?")
          : confirm("Are you sure you want to delete theese domains?");
  ...
  async mounted() {
    this.rows = this.getAllDomainsRows(await this.getAllDomains());
  },
};
</script>
